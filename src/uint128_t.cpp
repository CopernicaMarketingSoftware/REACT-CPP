...
uint128_t swap_endianness(uint128_t i128)
{
    union {
        uint64_t ui64;
        uint32_t ui32[2];
    } _64_as_32_high, _64_as_32_low, _32_as_64_high, _32_as_64_low;

    _64_as_32_high.ui64 = i128.upper();
    _32_as_64_high.ui32[1] = ntohl(_64_as_32_high.ui32[0]);
    _32_as_64_high.ui32[0] = ntohl(_64_as_32_high.ui32[1]);
    _64_as_32_low.ui64 = i128.lower();
    _32_as_64_low.ui32[1] = ntohl(_64_as_32_low.ui32[0]);
    _32_as_64_low.ui32[0] = ntohl(_64_as_32_low.ui32[1]);
    return uint128_t(_32_as_64_low.ui64, _32_as_64_high.ui64);
}
